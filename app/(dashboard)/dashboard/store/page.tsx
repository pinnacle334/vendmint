...
>("idle");
    ...
    // NOTE: Generates a unique slug from the store name by checking
    // the database and appending a numeric suffix if taken
    ...
    // NOTE: Pro sellers editing the slug get live availability checking
    ...
    return (
        <div className="flex flex-col gap-6 max-w-2xl">
            ...
            >
                ...
                {/* Slug field - only shown once a store exists */}
                {storeId && (
